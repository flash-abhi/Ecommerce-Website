    ...
    <div className='w-[99vw] min-h-screen bg-linear-to-l from-[#141414] to-[#0c2025] text-[white]'>
      ...
      <div className='w-full h-full flex items-center lg:justify-start justify-center'>
        ...
        <div className='lg:w-[85%] md:w-[70%] h-full lg:ml-[310px] md:ml-[250px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]'>
          <div className='w-[400px] h-[50px] text-[28px] md:text-[40px] mb-5 text-white'>All Orders List</div>
          {
           orders.map((order,index)=>(
            <div key={index} className='w-[90%] h-[40%] bg-slate-600 rounded-xl flex lg:items-center items-start justify-between  flex-col lg:flex-row p-2.5 md:px-5  gap-5'>
            ...
            <div className='text-[15px] text-green-100'>
                ...
                <select  value={order.status} className='px-[5px] py-2.5 bg-slate-500 rounded-lg border border-[#96eef3]' onChange={(e)=>statusHandler(e,order._id)} >
