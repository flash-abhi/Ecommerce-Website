...
function About() {
  return (
    <div className=' w-[99vw] min-h-screen pb-8 flex items-center justify-center flex-col  bg-linear-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-20'>
      ...
      <div className='w-full  flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-5  flex-col mt-5 lg:mt-0'>
          ...
          <p className='lg:w-[80%] w-full text-[15px] text-[white] lg:text-[18px] mt-2.5 font-bold'>Our Mission</p>
          <p className='lg:w-[80%] w-full text-[white] md:text-[16px] text-[13px]'>
