...
useEffect(()=>{
 loadOrderData()
  ...
  return (
    <div className='w-[99vw] min-h-screen p-5 pb-[150px]  overflow-hidden bg-linear-to-l from-[#141414] to-[#0c2025] '>
         ...
         orderData.map((item,index)=>(
            <div key={index} className='w-full h-[10%] border-t border-b '>
                <div className='w-full h-[80%] flex items-start gap-6 bg-[#51808048]  py-2.5 px-5 rounded-2xl relative '>
                    <img src={item.image1} alt="" className='w-20 h-[100px] md:w-[100px] lg:w-[130px] md:h-[130px] rounded-md '/>
                    ...
                    <div className='flex items-center'>
                     <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>Date: <span className='text-[#e4fbff] pl-2.5 md:text-[16px] text-[11px]'>{new Date(item.date).toDateString()}</span></p>
                    </div>
                    <div className='flex items-center'>
                    ...
                    <div className='absolute md:left-[55%] md:top-[40%] right-[2%] top-[2%]  '>
                     ...
                     <div className='absolute md:right-[5%] right-[1%] md:top-[40%] top-[74%]'> 
                    <button className='md:px-[15px] px-2.5 py-[3px] md:py-[7px] rounded-md bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointe active:bg-slate-500' onClick={loadOrderData} >Track Order</button>
                  </div>
                    </div>
                </div>
